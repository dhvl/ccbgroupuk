      ...
      <div className="relative z-10 max-w-4xl px-6 text-center">
        ...
        >
          ...
          <div className="flex justify-center">
            <div className="px-4 py-1.5 rounded-full text-xs font-medium tracking-[0.2em] text-blue-400 uppercase glass-panel">
              Coming Soon
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
            ...
            <Link href="/login">
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 text-white font-semibold rounded-full transition-colors hover:bg-white/10 glass-panel"
              >
                Admin Login
              </motion.div>
            </Link>
